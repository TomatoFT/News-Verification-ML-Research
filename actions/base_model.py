...
class BaseNewsVerificationModel:
    _name = None
    bert_base_model = None
    pretrained_bert_name = None


class (nn.Module, BaseNewsVerificationModel):
    def __init__(self):
        super(BERT_CNN, self).__init__()
        self._name = 'BERT'
        self.bert_base_model = BertModel.from_pretrained('bert-base-uncased')
